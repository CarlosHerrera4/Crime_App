define({
  root: ({
    ...
    instructions: "Arrastre el hombre Google® Vista de la calle en la calle que desea ver un panorama para. También puede arrastrar el hombre vista de la calle por el mapa, una vez que se ha colocado.",
